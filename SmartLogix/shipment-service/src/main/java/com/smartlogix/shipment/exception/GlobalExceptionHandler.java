...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(DispatchPointsNotFoundException.class)
    public ResponseEntity<ErrorResponse> handleNotFound(DispatchPointsNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND)
                .body(new ErrorResponse(OffsetDateTime.now(), HttpStatus.NOT_FOUND.value(), ex.getMessage()));
    }
    ...
    public ResponseEntity<ErrorResponse> handleCoupon(CouponOperationException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(new ErrorResponse(OffsetDateTime.now(), HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }
